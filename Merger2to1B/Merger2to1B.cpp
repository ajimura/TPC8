...
int Merger2to1B::read_InPort1()
{
#include "read_InPort1.inc"
}

int Merger2to1B::read_InPort2()
{
#include "read_InPort2.inc"
}

void Merger2to1B::Stock_data(int data1_byte_size, int data2_byte_size)
{
#include "Stock_data.inc"
}

int Merger2to1B::set_data(int data_byte_size)
{
