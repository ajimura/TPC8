...
//int Merger2to1A::set_data_OutPort(unsigned int data_byte_size)
//{
...
int Merger2to1A::set_data_OutPort(unsigned int data1_byte_size, unsigned int data2_byte_size)
{
