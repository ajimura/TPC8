...
static const char* merger2to1z_spec[] =
{
    "implementation_id", "Merger2to1Z",
    "type_name",         "Merger2to1Z",
    "description",       "Merger2to1Z component",
    "version",           "1.0",
...
Merger2to1Z::Merger2to1Z(RTC::Manager* manager)
    : DAQMW::DaqComponentBase(manager),
      m_InPort1("merger2to1z_in1", m_in1_data),
      m_InPort2("merger2to1z_in2", m_in2_data),
      m_OutPort("merger2to1z_out", m_out_data),
      ...
      m_inport2_recv_data_size(0)
{
    ...
    // Set InPort buffers
    registerInPort("merger2to1z_in1", m_InPort1);
    registerInPort("merger2to1z_in2", m_InPort2);
    registerOutPort("merger2to1z_out", m_OutPort);

    init_command_port();
    init_state_table();
    set_comp_name("MERGER2TO1Z");
}

Merger2to1Z::~Merger2to1Z()
{
}


RTC::ReturnCode_t Merger2to1Z::onInitialize()
{
    if (m_debug) {
        std::cerr << "Merger2to1Z::onInitialize()" << std::endl;
    }

    return RTC::RTC_OK;
}

RTC::ReturnCode_t Merger2to1Z::onExecute(RTC::UniqueId ec_id)
{
  //    std::cerr << "*** onExecute\n";
    daq_do();
...
int Merger2to1Z::daq_dummy()
{
    return 0;
}

int Merger2to1Z::daq_configure()
{
    std::cerr << "*** Merger2to1Z::configure" << std::endl;
...
int Merger2to1Z::parse_params(::NVList* list)
{
...
int Merger2to1Z::daq_unconfigure()
{
...
int Merger2to1Z::daq_start()
{
    std::cerr << "*** Merger2to1Z::start" << std::endl;
...
int Merger2to1Z::daq_pause()
{
    std::cerr << "*** Merger2to1Z::pause" << std::endl;
    return 0;
}

int Merger2to1Z::daq_resume()
{
    std::cerr << "*** Merger2to1Z::resume" << std::endl;
    return 0;
}
...
extern "C"
{
    ...
    {
        RTC::Properties profile(merger2to1z_spec);
        manager->registerFactory(profile,
                    RTC::Create<Merger2to1Z>,
                    RTC::Delete<Merger2to1Z>);
    }
};
