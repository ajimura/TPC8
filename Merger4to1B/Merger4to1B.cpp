...
unsigned int Merger4to1B::read_InPort1()
{
#include "read_InPort1.inc"
}

unsigned int Merger4to1B::read_InPort2()
{
#include "read_InPort2.inc"
}

unsigned int Merger4to1B::read_InPort3()
{
#include "read_InPort3.inc"
}

unsigned int Merger4to1B::read_InPort4()
{
#include "read_InPort4.inc"
}

unsigned int Merger4to1B::Stock_data(unsigned int data1_byte_size, unsigned int data2_byte_size,
				    unsigned int data3_byte_size, unsigned int data4_byte_size)
{
#include "Stock_data.inc"
}

int Merger4to1B::set_data(unsigned int data_byte_size)
{
